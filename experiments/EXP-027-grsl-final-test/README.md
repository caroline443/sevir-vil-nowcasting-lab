...
Decision: the final test passes the GRSL evidence gate. The configuration,
checkpoints and test outputs are permanently frozen.
...
Relative to the baseline, the method improves global mCSI by 4.48% and
...
The GRSL experimental package is complete. No further test evaluation,
hyperparameter tuning, native seed or backbone experiment is authorized for
this Letter. Remaining work is figure generation, concise qualitative analysis
and five-page manuscript preparation.
